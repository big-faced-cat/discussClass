...
<template>
    <div class="wrapper">
        ...
        <div class="content">
            <div class="show-info">
                <div class="test" v-if="add || imgAlter" >
                ...
                <div v-if="!add && !imgAlter">
                <img :src="imgUrl"  lazy style="height: 300px; width: 200px;"/>
                </div>
        ...
        methods: {
            ...
            finish2() {
                ...
                this.$refs.cropper2.getCropData((data) => {
                    ...
                    console.log('2222222222222222222222', this.modelSrc);
                    this.imageUrlss = this.modelSrc;

                    // let blobs =  URL.createObjectURL(this.toBlob(data));
                    // let filess = this.blobToFile(blobs, 'filess');
                    // console.log('filessssss', filess );

                    this.$emit("refresh-picData",   this.dataURLtoFile(data, 'fffffsss.png') );

                    // this.$emit("refresh-picData", data);
                })
            },

            uploadImg(e, num) {
                this.$emit("refresh-picData",  null );
                this.imgAlter = true;
                this.example2.img = ''
                var file = e.target.files[0];
                // this.$emit("refresh-picData", file);
                ...
                // 转化为blobcs
                // console.log('ggggggggggggggg', file);
                // reader.readAsArrayBuffer(file);
                // this.$emit("refresh-picData", file);
            },
            // blob转化成文件
